                        ...
                        <li class="nav-item dropdown">
                            <a class="dropdown-toggle profile-pic" data-toggle="dropdown" href="#"
                                aria-expanded="false"> <img src="../assets/img/profile.jpg" alt="user-img"
                                    width="36" class="img-circle"><span>ربيع علي</span></span> </a>
                    ...
                    <div class="info">
                        ...
                        <div class="collapse in" id="collapseExample" aria-expanded="true" style="">
                            <ul class="nav">
                                <li>
                                    <a href="#profile">
                                        <span class="link-collapse">الصفحة الشخصية</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="#edit">
                                        <span class="link-collapse">تعديل الصفحة الشخصية</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="#settings">
                                        <span class="link-collapse">اعدادات </span>
                                    </a>
                                </li>
                            </ul>
                        </div>
                                    ...
                                    <table class="table table-typo">
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <p class="text-primary">Lorem Ipsum is simply dummy text of the
                                                        printing and typesetting industry...</p></span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                ...
                                                <td>
                                                    <p class="text-info">Lorem Ipsum is simply dummy text of the
                                                        printing and typesetting industry...</p></span>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    <p class="text-success">Lorem Ipsum is simply dummy text of the
                                                        printing and typesetting industry...</p></span>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    <p class="text-warning">Lorem Ipsum is simply dummy text of the
                                                        printing and typesetting industry...</p></span>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    <p class="text-danger">Lorem Ipsum is simply dummy text of the
                                                        printing and typesetting industry...</p></span>
                                                </td>
                                            </tr>
                                            <tr>
